...
`,tn=({id:e,user:t,tweets:n,followers:a,avatar:r,isFollowing:i})=>{const l=C(),s=()=>{l($t(i?{id:e,followers:a-1,isFollowing:!1}:{id:e,followers:a+1,isFollowing:!0}))};return o.jsxs("div",{children:[o.jsxs(Jt,{children:[" ",o.jsx("source",{srcSet:`${D}`}),o.jsx("img",{src:D,alt:"logo"})]}),o.jsxs(Zt,{children:[" ",o.jsx("source",{srcSet:`${I}`}),o.jsx("img",{src:I,alt:"tweets"})]}),o.jsx(Gt,{}),o.jsx(Vt,{}),o.jsx(Kt,{src:r,alt:t}),o.jsxs(Xt,{children:[n," tweets"]}),o.jsxs(Ht,{children:[a.toLocaleString("en-US")," followers"]}),i?o.jsx(z,{isFollow:i,type:"button",onClick:s,children:o.jsx(Q,{children:"following"})}):o.jsx(z,{isFollow:i,type:"button",onClick:s,children:o.jsx(Q,{children:"follow"})})]})},nn=e=>e.tweets.items,At=e=>e.filters.status,en=e=>e.tweets.isLoading,rn=Nt([nn,At],(e,t)=>{switch(t){case b.follow:return e.filter(n=>!n.isFollowing);case b.followings:return e.filter(n=>n.isFollowing);default:return e}}),an=u.ul`
display: flex;
flex-wrap: wrap;
gap: 30px;
text-align: center;
